...
source $ad_hdl_dir/scripts/adi_ip_xilinx.tcl

adi_ip_create axi_ad9361
adi_ip_files axi_ad9361 [list \
  "$ad_hdl_dir/common/ad_rst.v" \
  "$ad_hdl_dir/xilinx/common/ad_data_clk.v" \
  "$ad_hdl_dir/xilinx/common/ad_data_in.v" \
  "$ad_hdl_dir/xilinx/common/ad_data_out.v" \
  "$ad_hdl_dir/xilinx/common/ad_dcfilter.v" \
  "$ad_hdl_dir/xilinx/common/ad_mul.v" \
  "$ad_hdl_dir/common/ad_pnmon.v" \
  "$ad_hdl_dir/common/ad_dds_cordic_pipe.v" \
  "$ad_hdl_dir/common/ad_dds_sine_cordic.v" \
  "$ad_hdl_dir/common/ad_dds_sine.v" \
  "$ad_hdl_dir/common/ad_dds_2.v" \
  "$ad_hdl_dir/common/ad_dds_1.v" \
  "$ad_hdl_dir/common/ad_dds.v" \
  "$ad_hdl_dir/common/ad_datafmt.v" \
  "$ad_hdl_dir/common/ad_iqcor.v" \
  "$ad_hdl_dir/common/ad_addsub.v" \
  "$ad_hdl_dir/common/ad_tdd_control.v" \
  "$ad_hdl_dir/common/ad_pps_receiver.v" \
  "$ad_hdl_dir/common/up_axi.v" \
  "$ad_hdl_dir/common/up_xfer_cntrl.v" \
  "$ad_hdl_dir/common/up_xfer_status.v" \
  "$ad_hdl_dir/common/up_clock_mon.v" \
  "$ad_hdl_dir/common/up_delay_cntrl.v" \
  "$ad_hdl_dir/common/up_adc_common.v" \
  "$ad_hdl_dir/common/up_adc_channel.v" \
  "$ad_hdl_dir/common/up_dac_common.v" \
  "$ad_hdl_dir/common/up_dac_channel.v" \
  "$ad_hdl_dir/common/up_tdd_cntrl.v" \
  "$ad_hdl_dir/xilinx/common/up_xfer_cntrl_constr.xdc" \
  "$ad_hdl_dir/common/ad_pps_receiver_constr.ttcl" \
  "$ad_hdl_dir/xilinx/common/ad_rst_constr.xdc" \
  "$ad_hdl_dir/xilinx/common/up_xfer_status_constr.xdc" \
  "$ad_hdl_dir/xilinx/common/up_clock_mon_constr.xdc" \
